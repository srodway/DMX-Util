                                  ...
                                  <fo:block>
                                    <fo:block space-before.optimum="1pt" space-after.optimum="2pt" white-space-collapse="false" linefeed-treatment="preserve" white-space-treatment="preserve">
                                      <fo:block>
                                        ...
                                        <fo:inline font-size="12pt">You are requested to act an an interpreter in a hearing for:</fo:inline>
                                        <fo:block>
                                          <fo:leader leader-pattern="space" />
                                        </fo:block>
                                        <fo:block>
                                                          ...
                                                          <fo:block>
                                                            <fo:block space-before.optimum="1pt" space-after.optimum="2pt">
                                                              <fo:block text-align="justify">
                                                                <fo:block space-before.optimum="1pt" space-after.optimum="2pt">
                                                                  <fo:block>
                                                                    <fo:inline font-size="10pt">You are requested to contact:</fo:inline>
                                                                    <fo:block>
                                                                      <fo:leader leader-pattern="space" />
                                                                    </fo:block>
                                                                    <fo:block>
                                                                      ...
                                                                      <fo:block text-align="left">
                                                                        ...
                                                                        <fo:block space-before.optimum="1pt" space-after.optimum="2pt" white-space-collapse="false" linefeed-treatment="preserve" white-space-treatment="preserve">
                                                                          <fo:block text-align="left">
                                                                            ...
                                                                            <fo:inline font-size="10pt">prior to the date of the hearing and provide the telephone number where you can be contacted at the time shown above. You are requested to be present at the number you provided to participate in a telephone hearing in connection with the hearing request filed in this matter. The hearing will be recorded.</fo:inline>
                                                                          </fo:block>
                                                                        </fo:block>
                                                                      </fo:block>
                                                                    </fo:block>
