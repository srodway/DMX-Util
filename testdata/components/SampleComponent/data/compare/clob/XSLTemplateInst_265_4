                                              ...
                                              <fo:block space-before.optimum="1pt" space-after.optimum="2pt" white-space-collapse="false" linefeed-treatment="preserve" white-space-treatment="preserve">
                                                <fo:block>
                                                  ...
                                                  <fo:inline font-size="12pt">
                                                    ...
                                                    to be a witness at a hearing at the following time:
                                                  </fo:inline>
                                                  <fo:block>
                                                    <fo:leader leader-pattern="space" />
                                                  </fo:block>
                                                                                    ...
                                                                                    <fo:block text-align="justify">
                                                                                      <fo:block space-before.optimum="1pt" space-after.optimum="2pt">
                                                                                        <fo:block text-align="justify">
                                                                                          <fo:block space-before.optimum="1pt" space-after.optimum="2pt">
                                                                                            <fo:block text-align="justify">
                                                                                              <fo:inline font-size="10pt">Questions concerning this notice should be directed to the party requesting your participation. If you have good cause not to participate in the hearing or produce any requested documents, you must present your reasons to the hearing official.</fo:inline>
                                                                                            </fo:block>
                                                                                          </fo:block>
                                                                                        </fo:block>
                                                                                      </fo:block>
