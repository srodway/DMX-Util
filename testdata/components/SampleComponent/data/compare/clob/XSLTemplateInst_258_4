                                            ...
                                            <fo:block space-before.optimum="1pt" space-after.optimum="2pt" white-space-collapse="false" linefeed-treatment="preserve" white-space-treatment="preserve">
                                              <fo:block>
                                                ...
                                                <fo:inline font-size="12pt">
                                                  ...
                                                  <xsl:apply-templates select="FIELD[FNAME='appellantName']" />
                                                  to be a representative at a hearing at the following time:
                                                </fo:inline>
                                                <fo:block>
                                                  <fo:leader leader-pattern="space" />
                                                </fo:block>
                                                ...
                                                <fo:block space-before.optimum="1pt" space-after.optimum="2pt">
                                                  <fo:block text-align="justify">
                                                    <fo:inline font-size="10pt">You are directed to be present on the above date and time at the address you provided to participate in a telephone hearing in connection with the hearing request filed in this matter. You may have such witnesses and evidence as you desire included in this hearing. If these witnesses will not attend the hearing in person, you must provide the telephone numbers where such witnesses can be reached at the time of the hearing. You may question witnesses and examine evidence presented at the hearing. The hearing will be recorded.</fo:inline>
                                                    <fo:block space-before.optimum="1pt" space-after.optimum="2pt">
                                                      <fo:block text-align="justify">
                                                        <fo:block space-before.optimum="1pt" space-after.optimum="2pt">
                                                          <fo:block>
                                                                      ...
                                                                      <fo:block text-align="left">
                                                                        ...
                                                                        <fo:block space-before.optimum="1pt" space-after.optimum="2pt" white-space-collapse="false" linefeed-treatment="preserve" white-space-treatment="preserve">
                                                                          <fo:block text-align="left">
                                                                            ...
                                                                            <fo:inline font-size="10pt">
                                                                              If you are late, your hearing may have to be abandoned. If you fail to participate in a scheduled hearing, your request will be considered abandoned unless within
                                                                              <xsl:apply-templates select="FIELD[FNAME='appealTimeLimit']" />
                                                                              days of the scheduled date, you request restoration of the hearing and you provide good cause for failing to participate.
                                                                            </fo:inline>
                                                                            <fo:block>
                                                                              <xsl:text />
                                                                            </fo:block>
