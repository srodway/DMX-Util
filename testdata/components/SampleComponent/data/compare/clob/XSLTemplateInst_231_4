          ...
          <fo:block>
            <fo:block space-before.optimum="1pt" space-after.optimum="2pt">
              <fo:block text-align="center">
                <fo:inline font-size="14pt" font-weight="bold">Notice of Home Hearing</fo:inline>
                <fo:block>
                                  ...
                                  <fo:block>
                                    <fo:block space-before.optimum="1pt" space-after.optimum="2pt" white-space-collapse="false" linefeed-treatment="preserve" white-space-treatment="preserve">
                                      <fo:block>
                                        ...
                                        <fo:inline font-size="12pt">In response to your request, your hearing will be held at the following time and place:</fo:inline>
                                        <fo:block>
                                          <fo:leader leader-pattern="space" />
                                        </fo:block>
                                        <fo:block>
                                        ...
                                        <fo:block space-before.optimum="1pt" space-after.optimum="2pt">
                                          <fo:block text-align="justify">
                                            <fo:inline font-size="10pt">You are directed to be present on the above date and time at the address you provided to participate in a home hearing in connection with the hearing request filed in this matter. You may have such witnesses and evidence as you desire included in this hearing. If these witnesses will not attend the hearing in person, you must provide the telephone numbers where such witnesses can be reached at the time of the hearing. You may be assisted at the hearing by a representative of your choice and you may question witnesses and examine evidence presented at the hearing. The hearing will be recorded.</fo:inline>
                                            <fo:block space-before.optimum="1pt" space-after.optimum="2pt">
                                              <fo:block text-align="justify">
                                                <fo:block space-before.optimum="1pt" space-after.optimum="2pt">
                                                  <fo:block>
                                                    <fo:block space-before.optimum="1pt" space-after.optimum="2pt">
                                                      <fo:block text-align="justify">
                                                        <fo:block space-before.optimum="1pt" space-after.optimum="2pt">
                                                          <fo:block>
                                                            <fo:inline font-size="10pt">If you are unable to appear at the scheduled time, you may request an adjournment by contacting:</fo:inline>
                                                            <fo:block>
                                                              <fo:leader leader-pattern="space" />
                                                            </fo:block>
                                                            <fo:block>
