          ...
          <fo:block>
            <fo:block space-before.optimum="1pt" space-after.optimum="2pt">
              <fo:block text-align="center">
                <fo:inline font-size="14pt" font-weight="bold">Subpoena to Witness for Hearing</fo:inline>
                <fo:block>
                                          ...
                                          <fo:block>
                                            ...
                                            <fo:block space-before.optimum="1pt" space-after.optimum="2pt" white-space-collapse="false" linefeed-treatment="preserve" white-space-treatment="preserve">
                                              <fo:block text-align="left">
                                                ...
                                                <fo:inline font-size="12pt">
                                                  You have been directed to appear and testify on behalf of
                                                              ...
                                                              <fo:block text-align="justify">
                                                                <fo:block space-before.optimum="1pt" space-after.optimum="2pt">
                                                                  <fo:block>
                                                                    ...
                                                                    <fo:inline font-size="10pt">Questions concerning this notice should be directed to the party requesting your appearance. If you have good cause not to appear at the hearing or produce any requested documents, you must present your reasons to the hearing official.
                                                                      Failure to appear and bring any requested documents with you may subject you to a penalty.</fo:inline>
                                                                  </fo:block>
                                                                </fo:block>
                                                              </fo:block>
                                                            </fo:block>
