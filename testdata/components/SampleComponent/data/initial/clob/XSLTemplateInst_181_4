    ...
    <fo:root>
      ...
      <fo:page-sequence master-reference="Section1-ps">
        ...
        <fo:flow flow-name="xsl-region-body" font-family="WT Sans">
          ...
          <fo:block xsl:use-attribute-sets="Normal_2"> </fo:block>
          <fo:block xsl:use-attribute-sets="Normal_2">If you have good cause not to participate in the hearing, you must present your reasons to the hearing official.</fo:block>
