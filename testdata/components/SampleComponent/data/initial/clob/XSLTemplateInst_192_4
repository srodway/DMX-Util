        ...
        <fo:flow flow-name="xsl-region-body" font-family="WT Sans">
          ...
          <fo:block text-align="center">
            <fo:inline font-weight="bold">
              <fo:inline xsl:use-attribute-sets="Normal_1">Notice of Continuance of Hearing</fo:inline>
            </fo:inline>
          </fo:block>
          ...
          <fo:block xsl:use-attribute-sets="Normal_2">To all Parties of Record:</fo:block>
          <fo:block xsl:use-attribute-sets="Normal_2">
            On
          ...
          <fo:block xsl:use-attribute-sets="Normal_2"> </fo:block>
          <fo:block xsl:use-attribute-sets="Normal_2">It has been found that good cause has been shown and that this continuance should be granted. Notice is hereby given that this hearing scheduled for is now continued to a later date. You will receive a separate notice advising you of the date, time and place of the continued hearing.</fo:block>
          <fo:block xsl:use-attribute-sets="Normal_2"> </fo:block>
          <fo:block xsl:use-attribute-sets="Normal_2">Yours Sincerely,</fo:block>
