        ...
        <fo:flow flow-name="xsl-region-body" font-family="WT Sans">
          ...
          <fo:block text-align="center">
            <fo:inline font-weight="bold">
              <fo:inline xsl:use-attribute-sets="Normal_1">Hearing Adjournment Notice</fo:inline>
            </fo:inline>
          </fo:block>
            ...
            <fo:table-body>
                ...
                <fo:table-cell xsl:use-attribute-sets="Cell_1">
                  <fo:block xsl:use-attribute-sets="Normal_3">
                    <fo:inline xsl:use-attribute-sets="Normal_3">
                      <fo:inline xsl:use-attribute-sets="Normal_2">Case Reference:</fo:inline>
                    </fo:inline>
                  </fo:block>
                </fo:table-cell>
              ...
              <fo:table-row>
                <fo:table-cell xsl:use-attribute-sets="Cell_3">
                  <fo:block xsl:use-attribute-sets="Normal_3">
                    <fo:inline xsl:use-attribute-sets="Normal_3">
                      <fo:inline xsl:use-attribute-sets="Normal_2">Concerning:</fo:inline>
                    </fo:inline>
                  </fo:block>
                </fo:table-cell>
                <fo:table-cell xsl:use-attribute-sets="Cell_4">
              ...
              <fo:table-row>
                <fo:table-cell xsl:use-attribute-sets="Cell_3">
                  <fo:block xsl:use-attribute-sets="Normal_3">
                    <fo:inline xsl:use-attribute-sets="Normal_3">
                      <fo:inline xsl:use-attribute-sets="Normal_2">Date of Original Hearing:</fo:inline>
                    </fo:inline>
                  </fo:block>
                </fo:table-cell>
                <fo:table-cell xsl:use-attribute-sets="Cell_4">
              ...
              <fo:table-row>
                <fo:table-cell xsl:use-attribute-sets="Cell_3">
                  <fo:block xsl:use-attribute-sets="Normal_3">
                    <fo:inline xsl:use-attribute-sets="Normal_3">
                      <fo:inline xsl:use-attribute-sets="Normal_2">Date Adjourned:</fo:inline>
                    </fo:inline>
                  </fo:block>
                </fo:table-cell>
                <fo:table-cell xsl:use-attribute-sets="Cell_4">
              ...
              <fo:table-row>
                <fo:table-cell xsl:use-attribute-sets="Cell_3">
                  <fo:block xsl:use-attribute-sets="Normal_3">
                    <fo:inline xsl:use-attribute-sets="Normal_3">
                      <fo:inline xsl:use-attribute-sets="Normal_2">Reason:</fo:inline>
                    </fo:inline>
                  </fo:block>
                </fo:table-cell>
                <fo:table-cell xsl:use-attribute-sets="Cell_4">
          ...
          <fo:block xsl:use-attribute-sets="Normal_3">
            <fo:inline xsl:use-attribute-sets="Normal_2">We wish to inform you that the above Hearing is adjourned. We will inform you when the next Hearing is scheduled.</fo:inline>
          </fo:block>
          <fo:block xsl:use-attribute-sets="Normal_3">
            <fo:inline xsl:use-attribute-sets="Normal_2"> </fo:inline>
          </fo:block>
